...
namespace IIS.Kur4
{
    ...
    [View("ДокументЗаказаE", new string[] {
            ...
            "Сотрудники.Должности as \'Должность\'",
            "Сотрудники.Должности.Наименование as \'Наименование должности\'"}, Hidden=new string[] {
            "Питание.КодПитания",
            "Питание.ВидПитания",
            ...
            "Сотрудники.Имя",
            "Сотрудники.Отчество",
            "Сотрудники.Должности.Наименование"})]
